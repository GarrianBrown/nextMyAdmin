...
/**
 * Minimal inline icon set (Lucide-style, 24-grid, currentColor stroke) used
 * across the phpMyAdmin-style chrome — nav tree, breadcrumbs, and tab bars.
 * Sizing is controlled by the parent via CSS (width/height on `svg`).
 */
...
export function PrivilegesIcon(props: SVGProps<SVGSVGElement>) {
  return (
    <svg {...base(props)}>
